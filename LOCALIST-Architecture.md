...
| 14 | [localist-mcp / MCP Tool Layer](docs/architecture/14-localist-mcp-tool-layer.md) | Authoritative | 2026-07-09 | The MCP tool server exposing `fetch_url`, `web_search` (now provider-agnostic — LangSearch default, Brave Search behind `SEARCH_PROVIDER`), and file-op tools; `MCPToolDispatcher`, configuration, port topology, and test coverage. |
